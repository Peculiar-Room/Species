...
public class TreeperModel<T extends Treeper> extends HierarchicalModel<T> {
    ...
    public static LayerDefinition getLayerDefinition() {
        ...
        PartDefinition trunk = partdefinition.addOrReplaceChild("trunk", CubeListBuilder.create().texOffs(0, 80).addBox(-16.0F, -133.0F, -16.0F, 32.0F, 144.0F, 32.0F, new CubeDeformation(-1.01F))
                .texOffs(128, 80).addBox(-16.0F, -133.0F, -16.0F, 32.0F, 144.0F, 32.0F, new CubeDeformation(-0.01F)), PartPose.offset(0.0F, -3.0F, 0.0F));

        PartDefinition leftEye = trunk.addOrReplaceChild("leftEye", CubeListBuilder.create().texOffs(0, 73).addBox(-4.0F, -4.0F, -0.125F, 8.0F, 8.0F, 0.0F, new CubeDeformation(0.0F))
                .texOffs(0, 70).addBox(-1.0F, -1.0F, -0.375F, 2.0F, 2.0F, 1.0F, new CubeDeformation(0.0F)), PartPose.offset(8.5F, -45.75F, -15.125F));

        PartDefinition rightEye = trunk.addOrReplaceChild("rightEye", CubeListBuilder.create().texOffs(0, 73).mirror().addBox(-4.0F, -4.0F, -0.125F, 8.0F, 8.0F, 0.0F, new CubeDeformation(0.0F)).mirror(false)
                .texOffs(0, 70).mirror().addBox(-1.0F, -1.0F, -0.375F, 2.0F, 2.0F, 1.0F, new CubeDeformation(0.0F)).mirror(false), PartPose.offset(-8.5F, -47.75F, -15.125F));

        PartDefinition canopy = trunk.addOrReplaceChild("canopy", CubeListBuilder.create().texOffs(64, 0), PartPose.offset(0.0F, -108.0F, 0.0F));
