...
public class Deepfish extends AbstractSchoolingFish {
    ...
    protected SoundEvent getFlopSound() {
        return SpeciesSoundEvents.DEEPFISH_FLOP.get();
    }

    @Nullable
    @Override
    protected SoundEvent getAmbientSound() {
        return SpeciesSoundEvents.DEEPFISH_IDLE.get();
    }

    @Nullable
    @Override
    protected SoundEvent getHurtSound(DamageSource source) {
        return SpeciesSoundEvents.DEEPFISH_HURT.get();
    }

    @Nullable
    @Override
    protected SoundEvent getDeathSound() {
        return SpeciesSoundEvents.DEEPFISH_DEATH.get();
    }
