...
public class SpeciesItems {
    ...
    public static final RegistryObject<Item> WRAPTOR_SPAWN_EGG = ITEMS.register("wraptor_spawn_egg", () -> new SpeciesSpawnEggItem(SpeciesEntities.WRAPTOR, 0xAF3A5F, 0x55C1A9, SpeciesDevelopers.NOON, new Item.Properties().stacksTo(64)));
    ...
    public static final RegistryObject<Item> DEEPFISH_SPAWN_EGG = ITEMS.register("deepfish_spawn_egg", () -> new SpeciesSpawnEggItem(SpeciesEntities.DEEPFISH, 0x5A5A5A, 0xED98BD, SpeciesDevelopers.BORNHULU, new Item.Properties().stacksTo(64)));
    ...
    public static final RegistryObject<Item> ROOMBUG_SPAWN_EGG = ITEMS.register("roombug_spawn_egg", () -> new SpeciesSpawnEggItem(SpeciesEntities.ROOMBUG, 0x5A3C29, 0xB4584D, SpeciesDevelopers.NINNI, new Item.Properties().stacksTo(64)));
