...
public class SpeciesBiomeModifier {
    ...
    public static void bootstrap(BootstapContext<BiomeModifier> context) {
        ...
        context.register(ADD_LIMPET, new ConditionalSpawnBiomeModifier(biomeTag(context, BiomeTags.IS_OVERWORLD), biomeTag(context, SpeciesTags.WITHOUT_LIMPET_SPAWNS), List.of(new MobSpawnSettings.SpawnerData(SpeciesEntities.LIMPET.get(), 30, 1, 1))));
