...
public class SpeciesSoundEvents {
    ...
    public static final RegistryObject<SoundEvent> ROOMBUG_DEATH = register("entity.roombug.death");
    public static final RegistryObject<SoundEvent> ROOMBUG_HURT = register("entity.roombug.hurt");
    public static final RegistryObject<SoundEvent> ROOMBUG_IDLE = register("entity.roombug.idle");
    public static final RegistryObject<SoundEvent> ROOMBUG_SNORING = register("entity.roombug.snoring");
    public static final RegistryObject<SoundEvent> ROOMBUG_EAT = register("entity.roombug.eat");
    public static final RegistryObject<SoundEvent> ROOMBUG_STEP = register("entity.roombug.step");
    public static final RegistryObject<SoundEvent> ROOMBUG_GOOFY_AAH_STEP = register("entity.roombug.goofy_aah_step");
