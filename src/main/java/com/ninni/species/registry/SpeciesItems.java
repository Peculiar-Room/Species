...
public class SpeciesItems {
    ...
    public static final Item SPRINGLING_SPAWN_EGG = register("springling_spawn_egg", new SpeciesSpawnEgg(SpeciesEntities.SPRINGLING, 0x472418, 0xDE5D34, SpeciesDevelopers.GLADOS, new Item.Properties().stacksTo(64)));
