...
public class SpeciesBlocks {
    ...
    public static final Block ALPHACENE_TALL_GRASS = register("alphacene_tall_grass", new DoublePlantBlock(BlockBehaviour.Properties.copy(Blocks.TALL_GRASS).sound(SpeciesSoundEvents.ALPHACENE_MOSS)));
    ...
    public static final Block ALPHACENE_MUSHROOM_GROWTH = register("alphacene_mushroom_growth", new AlphaceneMushroomGrowthBlock(BlockBehaviour.Properties.copy(Blocks.BROWN_MUSHROOM).sound(SoundType.WOOD).lightLevel(state -> 1).emissiveRendering((blockState, blockGetter, blockPos) -> true)));
