...
public class WraptorEntity extends AnimalEntity implements Monster, Shearable {
    ...
    public EntityData initialize(ServerWorldAccess world, LocalDifficulty difficulty, SpawnReason spawnReason, @Nullable EntityData entityData, @Nullable NbtCompound entityNbt) {
        this.getAttributeInstance(EntityAttributes.GENERIC_FOLLOW_RANGE).addPersistentModifier(new EntityAttributeModifier("Random spawn bonus", world.getRandom().nextTriangular(0.0, 0.11485000000000001), EntityAttributeModifier.Operation.MULTIPLY_BASE));
        return entityData;
    }
    ...
    protected void initGoals() {
        ...
        this.goalSelector.add(4, new TemptGoal(this, 1.2, Ingredient.fromTag(SpeciesTags.WRAPTOR_BREED_ITEMS), false));
    ...
    public static boolean canSpawn(EntityType <WraptorEntity> entity, ServerWorldAccess world, SpawnReason reason, BlockPos pos, Random random){
        return !world.getBlockState(pos.down()).isOf(Blocks.WARPED_WART_BLOCK);
    }
    @Override
