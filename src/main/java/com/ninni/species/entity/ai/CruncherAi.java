...
public class CruncherAi {
    public static final ImmutableList<SensorType<? extends Sensor<? super Cruncher>>> SENSOR_TYPES = ImmutableList.of(
            ...
            SensorType.HURT_BY,
            SpeciesSensorTypes.CRUNCHER_ATTACK_ENTITY_SENSOR.get()
    );
    public static final ImmutableList<MemoryModuleType<?>> MEMORY_TYPES = ImmutableList.of(
            ...
            SpeciesMemoryModuleTypes.ROAR_CHARGING.get(),
            SpeciesMemoryModuleTypes.STOMP_CHARGING.get(),
            SpeciesMemoryModuleTypes.SPIT_CHARGING.get(),
            SpeciesMemoryModuleTypes.ROAR_COOLDOWN.get()
    );
